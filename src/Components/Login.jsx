        ...
        <>
            ...
            <div className="auth-form-container">
                ...
                <form className="login-form" onSubmit={handleSubmit}>
                    ...
                    <input style={{ border: '1px solid #d02500' }} value={usernameContext.username} onChange={(e) => usernameContext.setUsername(e.target.value)} type="username" placeholder="Enter your username here" id="username" name="username" />

                    <label htmlFor="password">Password</label>
                    <input style={{ border: '1px solid #d02500' }} value={pass} onChange={(e) => setPass(e.target.value)} type="password" placeholder="Enter your password here" id="password" name="password" />
                    <div>
